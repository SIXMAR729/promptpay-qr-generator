...
(async () => {
    ...
    const qrCode = await createQrPromptPay(phoneNumber, isActive, countryCode, amount, currency);
    console.log("Generated QR Code:", qrCode); // Outputs the base64-encoded QR code image
})();
